import { APIError, Client, FetchQueue, Message, MessageResolvable, RawMessageData } from "../../../internal";
import getRoute from "../../../util/getRoute";

export default async function getFollowupMessage(client: Client, interactionToken: string, messageResolvable: MessageResolvable): Promise<Message | undefined> {

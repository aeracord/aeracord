import { Base, Client, ModifyGuildStickerData, RawStickerData, ReadyStates, StickerData, StickerFormatType, StickerType, User } from "../../internal";
...
export default class Sticker extends Base<Sticker> {
    ...
    constructor(client: Client, stickerData: StickerData) {
         ...
         */
        if ((client._stickers.cacheAll) && (client._readyState === ReadyStates.READY)) this.cache();
    }

...
export default class Guild extends Base<Guild> {
    ...
    constructor(client: Client, guildData: GuildData) {
         ...
         */
        if ((client._guilds.cacheAll) && (client._readyState === ReadyStates.READY)) this.cache();
    }
     ...
     */
    getActiveThreads(): Promise<ThreadChannel[]> {

import { Base, Client, GuildWidgetData, ModifyGuildWidgetData, RawGuildWidgetData, ReadyStates } from "../../internal";
...
export default class GuildWidget extends Base<GuildWidget> {
    ...
    constructor(client: Client, guildWidgetData: GuildWidgetData) {
         ...
         */
        if ((client._guildWidgets.cacheAll) && (client._readyState === ReadyStates.READY)) this.cache();
    }

import { Base, ChannelResolvable, Client, CreateGuildBanData, MemberData, ModifyGuildMemberData, RawMemberData, RoleResolvable, ReadyStates, UserData } from "../../internal";
...
export default class Member extends Base<Member> {
    ...
    constructor(client: Client, memberData: MemberData) {
         ...
         */
        if ((client._members.cacheAll) && (client._readyState === ReadyStates.READY)) this.cache();
    }

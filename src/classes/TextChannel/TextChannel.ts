import { CacheManagerInterface, Client, CreateWebhookData, CHANNEL_TYPE_TEXT, Interaction, Invite, InviteData, Message, TextChannelData, Webhook, WebhookData } from "../../internal";
